    ...
    <div class="bd">
     <ul>
       <form class="write_login">
	     <fieldset>
		 <ul>
         <li class="frame_style form_error"><label class="user_icon"></label><input name="用户名/手机号/邮箱" type="text"  id="username" onchange="checkUsername($(this))"/><i>用户名/手机号/邮箱</i></li><span style="font-size: 10px;color: red"/>
         <li class="frame_style form_error"><label class="password_icon"></label><input name="密码" type="password"   id="userpwd" onchange="checkPass($(this))"/><i>密码</i></li>
         </ul>
		 <div class="space"></div>
